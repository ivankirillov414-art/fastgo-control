...
self.addEventListener('fetch',event=>{
 ...
 if(req.method!=='GET'||url.origin!==ROOT.origin||!paths.has(url.pathname)||url.searchParams.has('code')||url.searchParams.has('token_hash')||req.headers.has('Authorization'))return;
