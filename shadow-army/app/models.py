...
class Agent(Base, TimestampMixin):
    ...
    rank: Mapped[AgentRank] = mapped_column(Enum(AgentRank), default=AgentRank.E)
...
class Approval(Base, TimestampMixin):
    ...
    status: Mapped[ApprovalStatus] = mapped_column(Enum(ApprovalStatus), default=ApprovalStatus.WAITING)
