...
test('repair intake rejects manual assignment to a non-mechanic',async()=>{
  const s=setup({role:'owner'});
  const r=await s.invoke({action:'create',params:{
    kind:'repair',
